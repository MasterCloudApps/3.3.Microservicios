...
public class CustomerController {
    ...
    @GetMapping("/")
    public Collection<CustomerResponseDto> getOrders() {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Customer not found",
                    content = @Content)})
    @GetMapping("/{id}")
    public CustomerResponseDto getUser(@Parameter(description = "id of customer to be searched")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid user attributes supplied",
                    content = @Content)})
    @PostMapping("/")
    public CustomerResponseDto createOrder(@Valid @RequestBody CustomerRequestDto customerRequestDto) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Customer not found",
                    content = @Content)})
    @DeleteMapping("/{id}")
    public CustomerResponseDto deleteUser(@Parameter(description = "id of customer to be deleted") @PathVariable long id) {
