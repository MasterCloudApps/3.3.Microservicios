...
@RestController
@RequestMapping("/api/v1/monolith")
public class MonolithController {
    ...
    public Collection<EmployeeResponseDto> getEmployees() {
        return this.monolithService.findAll();
    }
    ...
    @PathVariable String employeeId) {
            return this.monolithService.findById(Long.parseLong(employeeId));
    }
    ...
    public EmployeeResponseDto createOrder(@Valid @RequestBody EmployeeRequestDto employeeRequestDto) {
        return this.monolithService.save(employeeRequestDto);
    }
    ...
    public EmployeeResponseDto deleteUser(@Parameter(description = "id of employ to be deleted") @PathVariable long id) {
        return this.monolithService.delete(id);
    }
}
